...
class EquipementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $equipements = $em->getRepository('PFEDashBundle:Equipement')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('saisi_equipe_show', array('id' => $equipement->getId()));
        }
    ...
    public function editAction(Request $request, Equipement $equipement)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('saisi_equipe_edit', array('id' => $equipement->getId()));
        }
    ...
    public function deleteAction(Request $request, Equipement $equipement)
    {
        ...
        return $this->redirectToRoute('saisi_equipe_index');
    }
    ...
    private function createDeleteForm(Equipement $equipement)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('saisi_equipe_delete', array('id' => $equipement->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
